        ...
        <div className="flex items-center justify-between px-4 md:px-6 py-2 text-xs text-muted-foreground">
          <div className="flex items-center gap-2 md:gap-4 overflow-x-auto">
            <span className="flex items-center gap-1 whitespace-nowrap">
              ...
              <span className="hidden sm:inline">Made with love by Arsani Magdi the CEO / FOUNDER & CO - FOUNDER of ARSANI Tech </span>
              ...
              <span className="hidden sm:inline">to get in touch email me at : costmerservice@arsanitecheg.onmicrosoft.com</span>
